...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"patient_url": "https://walk.example.org/patient/RGN-0417?not_token=abc"},
        {"patient_url": "https://walk.example.org/patient/RGN-0417?token="},
        {"patient_url": "https://walk.example.org/patient/RGN-0417?token=a&token=b"},
        {"patient_url": "https://walk.example.org/patient/RGN-0417?token=abc#frag"},
